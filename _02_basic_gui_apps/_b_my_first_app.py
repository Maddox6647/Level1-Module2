...
class FirstApp(tk.Tk):
    ...
    def __init__(self):
        ...
        self.label = tk.Label(self, text="bobby and shrek", bg='yellow',
                              fg='blue', font=('times new roman', 32, 'bold'), relief='solid')
        ...
        self.label2 = tk.Label(self, text='nick', bg='green',
                               fg='red', font=('times new roman', 100, 'bold'), relief='solid')
        # TODO 8) Place the label somewhere on your app
        self.label2.place(relx=0.03, rely=0.5, relwidth=0.95, relheight=0.25)
...
if __name__ == '__main__':
    ...
    first_app.title('FUN FACT: shrek is actually gay with donkey')
